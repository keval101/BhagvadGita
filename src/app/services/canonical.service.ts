...
export class CanonicalService {
  ...
  updateMetaTags(tagsDesctiption: IMetaTags): void {
    ...
    this._meta.updateTag( { name: "image", content: 'https://bhagvad-gita.vercel.app/assets/krishna-arjuna.jpg' }, "name='image'");
    ...
    this._meta.updateTag( { property: 'og:image:secure_url', content: 'https://bhagvad-gita.vercel.app/assets/krishna-arjuna.jpg' }, "property='og:image:secure_url'");
    ...
    this._meta.updateTag({ name: 'twitter:image', content: `https://bhagvad-gita.vercel.app/assets/krishna-arjuna.jpg`}, "name='twitter:image'")
